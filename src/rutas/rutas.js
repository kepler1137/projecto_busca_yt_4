...
rutador.get("/", (req, res) => {
    var encontradas = fs.readFileSync("projecto_busca_yt_4/src/ubicada.json", "utf-8");
...
rutador.get("/servidor", (req, res) => {
    var estado_servidor = fs.readFileSync("projecto_busca_yt_4/src/errores.json", "utf-8");
...
rutador.get("/contador", (req, res) => {
    var estado_contador = fs.readFileSync("projecto_busca_yt_4/src/contador.json", "utf-8");
