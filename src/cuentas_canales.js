// cuentas de la mil putas y los canales donde esa perra posiblemente ande
module.exports = {
    cuentas: [
        ...
        "UC4FDfG0svLWr8UTygKkQROA", // indio mauri
        ...
        "UCHGLvsUrym0gTTEnerO-6Kw", // karem mio
        "UC8FnmZjIX4M_fUP86gXhRxw", // ROSSI india mauri
        "UCkR6cQGPhxwfSqCq5K9SBeQ", // MIO CLIN BARRIL
    ],

    canales: [
/*
        "UCvNogbKXdmFScYgEgLNU_4g", // larissa (80s)
        "UCpxY5zDygRzDIP5bTtTI5rA", // italo disco (80s)
        "UCxBAtJ0GmD6mhPlidFttkNA", // disco hits (80s)
        "UCLo_UlgP6CF8sgAjkDM3gJw", // disco music (80s)
        "UC-ITe1nKavRL6-Sl2aE3LKA", // music hits (80s)
        "UCnrM0k6ORcRDod2ytUZ4b7g", // Golden Disco Dance (80s)
        "UCeba3pJpMflswMBIANH1u7w", // Best Slow Rock (MAYA) (80s)
        ...
        "UCIDO7u5X7sXXyqVU_KA4GwQ", // Romanticas Música (LATINA)
        "c/BaladasRomanticasÉxitos", // Baladas Romanticas Éxitos (LATINA)

        "c/JAZZBLUES37999", // JAZZ Y BLUES (JAZZ)
        "UC7bX_RrH3zbdp5V4j5umGgw", // relax music (jazz paris) (JAZZ)
        "UCeGJ6v6KQt0s88hGKMfybuw", // Cozy Jazz Music (JAZZ)

        "c/PMBMusic", // PMB MUSIC (cristo rio bossa nova) (RELAJANTE)
        "c/musicbrokers", // music brokers (RELAJANTE)
        "c/PlaylistsKool", // bossa arena cafe playa (RELAJANTE)
        "c/ILoveYouVenice", // venecia vivo (RELAJANTE)
        "c/Teleportcamera", // Teleport.camera (RELAJANTE)
        


        
        "c/JackFrancisComposer", // OCB Relax Music (RELAJANTE)
        "user/YourRelaxMusic1", // Música Relajante, de Meditación, Música para Dormir (RELAJANTE)
        "c/CassioToledo", // CASSIO TOLEDO (CALMAR) (RELAJANTE)
        "c/PianoMusica", // PIANO MUSICA (RELAJANTE)
        "UC_GGWVDrDwGAunoFRiWbHDw", // soul relajante (RELAJANTE)
        "UCS4kVH1srJ9h9nqJPG2iDLg", // sat-chit musica y mantras (RELAJANTE)
        "c/MellowDream", // relajante (ford comander) (RELAJANTE)
        "UCy-jpxAHSt4wz_eruVuz_4A", // RELAX TIME (relajante ruso) (RELAJANTE)
        "UCMNiaUs8-Lb5TzwhjLcswAw", // 4K Scenic Relaxation (relajante ruso) (RELAJANTE)
        "UCsHOUGUpmJo73KONPz3DTkQ", // Lucid Dreaming Music (relajante) (RELAJANTE)
        "UCmZzJBHL3kC1z2PwsJOxFxA", // QT Relax Music (RELAJANTE)
        */
        
        "UCC0XEDBRtOO2GPC_DP4hR3w", // Beautiful Melody (RELAJANTE)
        "c/SoothingRelaxation", // Soothing Relaxation (RELAJANTE)
        "c/MusicaRelajanteBeautifulDreams", // Musica Relajante - Beautiful Dreams (RELAJANTE)
        ...
        "UCfAqGlaQDI4uNrezkuuVYIQ", // Soothing Meditation Music (RELAJANTE)
        "c/AlexdelosReyesmusicTHR", // Healing Your Spirit (RELAJANTE)
        "user/muljanic", // Relax Your Mind (RELAJANTE)
        "UCRZnWilWTPU50kZxlGaC_nQ", // Coffee Music TBM (RELAJANTE)
        
        /*
        "c/OddEagleProductions", // Odd Eagle (RELAJANTE)
        "UCv4KQtNQ3bS5jPCOa6F9LBw", // Music Heals the Soul (RELAJANTE)
        "UC_18SY0IqUBsVX3vyjoT8BQ", // Healing Your Spirit (RELAJANTE)
        "UCTiXaqByXkH-h97DLlLkx1Q", //Queen Club (RELAJANTE)
        "UCJW3ePyqjsvKfHGsz7eetQA", // wonder deep (RELAJANTE)
        "c/TheGoodLiferadio", // The Good Life Radio x Sensual Musique (RELAJANTE)
        "UCWal9QzIup8uxqWbI30JVyA", // Music Hits Ever (RELAJANTE)
        "UC6g_Yf3YTagd95_DYFX6Yrw", // Music Hits All Time BOD MARLEY (RELAJANTE)
        "c/MagicSpider", // Wonder EDM (RELAJANTE)

        "c/Gentleman1", // gentleman (HOUSE)
        "user/dav0delik", //XDeep Club (HOUSE)
