...
app.listen(app.get("puerto"), async () => {
    ...
    fs.writeFileSync("projecto_busca_yt_4/src/contador.json", string_limpio, "utf-8");
    fs.writeFileSync("projecto_busca_yt_4/src/errores.json", string_limpio, "utf-8");
    fs.writeFileSync("projecto_busca_yt_4/src/ubicada.json", string_limpio, "utf-8");
    //--------------------------------------------------------

    var erroresjson = fs.readFileSync("projecto_busca_yt_4/src/errores.json", "utf-8");
    var errores_json = JSON.parse(erroresjson);
    // ------- Para verificación -------
    console.log("EL ERORRRR");
    console.log(errores_json);

    var ubicadajson = fs.readFileSync("projecto_busca_yt_4/src/ubicada.json", "utf-8");
    var ubicada_json = JSON.parse(ubicadajson);
    // ------- Para verificación -------
    console.log("EL UBICADO");
    console.log(ubicada_json);

    var contadorjson = fs.readFileSync("projecto_busca_yt_4/src/contador.json", "utf-8");
    ...
    for (let cc = 0; cc < num_corridas; cc++) {
        try {
                ...
                if (directos_live.length > 0) {
                    for (let k = 0; k < directos_live.length; k++) {
                        try {
                            ...
                            fs.writeFileSync("projecto_busca_yt_4/src/contador.json", string_contador, "utf-8");
                            ...
                            for (let r = 0; r < puta_ids.length; r++) {
                                ...
                                if (posicion_puta != -1) {
                                    ...
                                    var json_inicial = fs.readFileSync("projecto_busca_yt_4/src/ubicada.json", "utf-8"); // json_inicial ESTARA EN STRING
                                    ...
                                    fs.writeFileSync("projecto_busca_yt_4/src/ubicada.json", json_actualizado, "utf-8");
                                    await page.waitForTimeout(3000); // para esperar el cargado de la pagina
                                }
                            }
                            ...
                            fs.writeFileSync("projecto_busca_yt_4/src/errores.json", json_actualizado_err_a, "utf-8");
                        }
                    }
                }
            ...
            fs.writeFileSync("projecto_busca_yt_4/src/errores.json", json_actualizado_err_b, "utf-8");
        }
        ...
        fs.writeFileSync("projecto_busca_yt_4/src/errores.json", estado_corrida_f, "utf-8");
    }
});
